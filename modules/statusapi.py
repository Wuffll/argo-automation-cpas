...
class StatusAPI:
    ...
    async def report_status(self, session, tenant_id, status, token):
    ...
    async def update_job_status(self, session, tenant_id, event, status, token,
    ...
    async def get_job_status(self, session, tenant_id, event, token):
        url = self._url(tenant_id)
        headers = self._auth_headers(token)
    ...
    async def fetch_status(self, session, tenant_id, token):
        url = self._url(tenant_id)

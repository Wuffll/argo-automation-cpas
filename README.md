...
| `url_api_integrations`  | API URL used for fetching component-admin AMS token.                                                                                                               | `/v1/integrations/{component}/by-project-name/{project_name}/refresh` |
| `token_component_admin` | component-admin token needed for fetching AMS tokens.                                                                                                              | _(secret)_                                                            |
| `components`            | List of components; for each component on the list an AMS token is fetched.                                                                                        | `argo-monbox, argo-archiver`                                          |
